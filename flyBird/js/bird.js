var bird = {
    ...
    showBird: function(parentObj){
        ...
        parentObj.appendChild(this.div) // 把小鸟DIV插入到游戏界面上
    },
    fallSpeed: 0, // 小鸟下落的速度
    flyBird: function(){// 控制小鸟下落的速度
        ...
        function fly(){
            ...
            if(bird.div.offsetTop >= 395){
                bird.fallSpeed = 0
                clearInterval(bird.flyTimer) //一旦飞到地面就清除定时器
                clearInterval(bird.wingTimer)
            }
            if(bird.fallSpeed > 12){
                bird.fallSpeed = 12 // 控制小鸟下落的速度最大不超过12
            }
        }
    },
